...
SELECT v.matrícula, tv.tipo_vehículo, v.modelo, v.numero_puertas, v.capacidad, v.has_sunfoof, v.motor, v.color, v.valor_alquiler_semanal, v.valor_alquiler_diario, v.disponible 
FROM VEHÍCULOS AS v, tipo_vehículo AS tv
WHERE v.código_tipo_vehículo = tv.código_tipo_vehículo; 
...
SELECT CONCAT(u1.nombres,' ',u1.apellidos) 'Nombre cliente', CONCAT(u2.nombres,' ',u2.apellidos) 'Nombre vendedor', v.modelo, v.matrícula, a.dias, a.valor_cotizado, a.fecha_salida, s1.ciudad 'Sucursal alquiler', a.fecha_esperada_llegada,  a.fecha_llegada, s2.ciudad 'Sucursal entrega'
