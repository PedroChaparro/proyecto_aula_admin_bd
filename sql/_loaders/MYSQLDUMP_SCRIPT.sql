...
CREATE TABLE `alquileres` (
  ...
  CONSTRAINT `fk_alquileres_vehículo` FOREIGN KEY (`id_vehiculo`) REFERENCES `vehiculos` (`id_vehiculo`) ON UPDATE CASCADE
