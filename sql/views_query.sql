...
SELECT v.id_vehículo, v.matrícula, tv.tipo_vehículo, v.modelo, v.numero_puertas, v.capacidad, v.has_sunroof, tm.motor, v.color, v.descuento, v.valor_alquiler_semanal, v.valor_alquiler_diario, v.disponible
...
SELECT CONCAT(u1.nombres,' ',u1.apellidos) 'Nombre_cliente', CONCAT(u2.nombres,' ',u2.apellidos) 'Nombre_vendedor', 
	v.modelo, v.matrícula, c1.ciudad 'Ciudad_alquiler', c2.ciudad 'Ciudad_entrega', a.dias, a.valor_cotizado, 
